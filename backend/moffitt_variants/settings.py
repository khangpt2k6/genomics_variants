"""
Django settings for moffitt_variants project.

This module contains all the configuration settings for the Moffitt Variants
...
ROOT_URLCONF = 'moffitt_variants.urls'
WSGI_APPLICATION = 'moffitt_variants.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.getenv('LOG_FILE', 'logs/moffitt_variants.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
