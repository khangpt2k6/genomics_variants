...
class CancerTrendPrediction(models.Model):
    ...
    predicted_variant_counts = models.JSONField(default=list, blank=True)
    prediction_dates = models.JSONField(default=list, blank=True)
    confidence_intervals = models.JSONField(default=list, blank=True)

    key_trends = models.JSONField(default=list, blank=True)
    significant_genes = models.JSONField(default=list, blank=True)
    clinical_patterns = models.JSONField(default=list, blank=True)
    drug_implications = models.JSONField(default=list, blank=True)
    risk_assessment = models.TextField(blank=True)
    recommendations = models.JSONField(default=list, blank=True)

    trend_chart_data = models.JSONField(default=dict, blank=True)
    gene_chart_data = models.JSONField(default=dict, blank=True)
